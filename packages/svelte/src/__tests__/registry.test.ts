...
describe('flag registry', () => {
  it('rounded export count is 262', () => {
    expect(roundedKeys.length).toBe(262)
  })

  it('circle export count is 262', () => {
    expect(circleKeys.length).toBe(262)
  })
  ...
  it('every rounded component has non-empty inner svgContent', () => {
    expect(Object.keys(roundedModules).length).toBe(262)
  ...
  it('every circle component has non-empty inner svgContent', () => {
    expect(Object.keys(circleModules).length).toBe(262)
